    ...
    <section className="py-16 md:py-24 bg-white" id="servicii">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-10 text-center">
          <a href="#contact" className="inline-flex items-center justify-center px-6 py-4 rounded-xl text-lg font-semibold bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/20 transition">Cere Ofertă</a>
        </div>
      </div>
    </section>
  )
