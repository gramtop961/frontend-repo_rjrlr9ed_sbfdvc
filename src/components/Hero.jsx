...
const Hero = ({ onCTAClick }) => {
  return (
    <section className="relative overflow-hidden bg-slate-900">
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-blue-400/10 to-red-500/10" />
      <div className="container mx-auto px-6 py-24 md:py-32 relative">
        <div className="max-w-3xl">
          <span className="inline-flex items-center gap-2 text-blue-300 bg-blue-300/10 px-3 py-1 rounded-full text-sm mb-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <button onClick={onCTAClick} className="inline-flex items-center justify-center px-6 py-4 rounded-xl text-lg font-semibold bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-600/20 transition">
              Cere Ofertă în 60s
            </button>
